...
class CreatePollUseCase:
    ...
    async def execute(self, chat_id: int, lunch_time: str, place_name: str, end_time: str):
        poll_message = await self.poll_service.send_poll(chat_id, lunch_time, place_name, end_time)
